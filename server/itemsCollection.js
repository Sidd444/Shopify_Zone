const itemsCollection = [
  {
    ...
    price: 699,
    size: ["36", "38", "40"],
    highlights: ["dark-green", "claf-leather", "Medusa-head-motif"],
    image: [
      {
        fieldname: "images",
  ...
  },
  {
    ...
    price: 351,
    size: ["XS", " S", " M", " L", " XL"],
    highlights: ["Black", " Cotton", " Creq neck", " VLogo Signature"],
    image: [
      {
        fieldname: "images",
  ...
  },
  {
    ...
    detail:
      "Crafted in a straight-leg silhouette, these black Valentino jeans are trimmed with wispy feathers at the hem for a tactile completion.",
    image: [
      {
        fieldname: "images",
        originalname: "valentino-1.jpg",
  ...
  },
  {
    ...
    detail:
      "Palm Angels continues to provide L.A inspired streetwear in this AW22 collection. Made from stretch-modal, this long-sleeved T-shirt dress is subtly elevated by an embroidered logo at the chest. Dropped shoulders and a batwing style add to the laid-back aesthetic.",
    image: [
      {
        fieldname: "images",
  ...
  },
  {
    ...
    detail:
      "Irreverent brand Off-White puts a streetwear spin on a classic pencil silhouette, by adorning this pencil midi skirt with an all-over intarsia pattern of its signature Arrows logo. A contrasting neon-pink hem adds an extra distinctive touch, in tune with the label's creative aesthetic.",
    image: [
      {
        fieldname: "images",
  ...
  },
  {
    ...
    detail:
      "Mugler's AW22 collection includes this pair of straight-leg tailored trousers in a stone brown hue. True to the label's sculptural roots, the trousers feature a cut-out detail at the waist with an adjustable belt fastening.",
    image: [
      {
        fieldname: "images",
  ...
  },
  {
    ...
    detail:
      "Simon Porte Jacquemus delivers innovative style with a timeless appeal. This wool-blend halterneck dress is given an alternative finish through contrast stitching, cut-outs and asymmetric details.",
    image: [
      {
        fieldname: "images",
